...
namespace News2025
{
    public partial class CultureSceneControl1 : UserControl
    {
        ...
        // Tách 3+ dòng thành 2 phần: dòng đầu và phần còn lại (dùng cho 3Line treated as 2Line)
        ...
        public CultureSceneControl1(IKarismaCG3Model karismaCG3, IStatusReporter statusReporter)
        {
            InitializeComponent();
        ...
        public void Reload()
        {
            ControlConfig = ConfigService.GetConfigSection("CultureSceneSettings");
        ...
        private void LT_ShowFirst(string newText)
        {
            ...
            switch (tag)
            {
                ...
                case LineTag.Three:
                    var (tl1, tl2) = SplitThreeLinesToTwo(newText);  // 3+ dòng → treat as 2Line
                    Play_2Line_In(tl1, tl2);           // Phát như 2 dòng với line1 và rest combined
                    currentRaw = newText;
                    currentL1 = tl1; currentL2 = tl2;
                    break;
        ...
        private void LT_TransitionTo(string newText)
        {
            ...
            switch (currentTag)
            {
                case LineTag.One: // cũ: 1 dòng (LT Title-size)
                    ...
                    {
                        var (ntl1, ntl2) = SplitThreeLinesToTwo(newText);
                        Play_Title_to_2Line(currentRaw, ntl1, ntl2);  // Treat as 2Line
                        currentL1 = ntl1; currentL2 = ntl2;
                    }
                    break;
                ...
                case LineTag.Two: // cũ: 2 dòng
                    ...
                    {
                        var (ntl1, ntl2) = SplitThreeLinesToTwo(newText);
                        Play_2Line_to_2Line(currentL1, currentL2, ntl1, ntl2);  // Treat as 2Line
                        currentL1 = ntl1; currentL2 = ntl2;
                    }
                    break;

                case LineTag.Three: // cũ: 3 dòng+ (treated as 2Line)
                    if (newTag == LineTag.One)
                    {
                        Play_2Line_to_Title(currentL1, currentL2, newText);  // Use 2Line logic
                        currentL1 = newText; currentL2 = string.Empty;
                    }
                    else if (newTag == LineTag.Two)
                    {
                        var (nl1, nl2) = SplitTwoLines(newText);
                        Play_2Line_to_2Line(currentL1, currentL2, nl1, nl2);  // Use 2Line logic
                        currentL1 = nl1; currentL2 = nl2;
                    }
                    else // LineTag.Three
                    {
                        var (ntl1, ntl2) = SplitThreeLinesToTwo(newText);
                        Play_2Line_to_2Line(currentL1, currentL2, ntl1, ntl2);  // Use 2Line logic
                        currentL1 = ntl1; currentL2 = ntl2;
                    }
                    break;
        ...
        private void LT_PlayOutCurrentText()
        {
            ...
            switch (currentTag)
            {
                ...
                case LineTag.Three: // 3+ dòng (treated as 2Line)
                    _karismaCG3.PlayTwoLineOut(textOutScene, textLayer, currentL1, currentL2);
                    break;
            }
        ...
        private void btnTroiTinTuc_Click(object sender, EventArgs e)
        {
            ...
            _frmTroiTinTuc = new frmTroiTinTuc(_karismaCG3, layer, speed, scenePath, "CultureSceneSettings");
        ...
        private void btnTroiCuoi_Click(object sender, EventArgs e)
        {
            ...
            _frmTroiNgang = new frmTroiNgang(_karismaCG3, layer, speed, scenePath, "CultureSceneSettings");
